...
ids_file="${base_project}/rosmap/all_ids.txt"
fastq_dir="${base_project}/rosmap/fastq"
run_dir="${base_project}/rosmap/rapid_run/${genome}/${transcriptome}/run"
script_path="${base_project}/RAPiD-nf-21.04.1/RAPiD.nf"
nextflow_bin="/sc/arion/projects/H_PBG/nextflow/bin/nextflow"
