...
all_sene = qread("all_Aucell_results_with_cutoffs_UCLA-ASD.qs") #see aucell
sces3 =readRDS("sce_all_UCLA-ASD.RDS") #see setup
...
resfinal=foreach(i = percentages) %do% {
    ...
    print(i)
    file = paste0(folder, paste0("UCLA_ASD_pseudobulk_", i, ".qs"))
    if (!file.exists(file)){
