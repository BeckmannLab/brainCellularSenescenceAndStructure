...
all_sene = qread("all_Aucell_results_with_cutoffs_Girgenti_multiome.qs") #see aucell
sces3 =readRDS("sce_all_Girgenti_multiome.RDS") #see setup
...
resfinal=foreach(i = percentages) %do% {
    ...
    print(i)
    file = paste0(folder, paste0("Girgenti_multiome_pseudobulk_", i, ".qs"))
    if (!file.exists(file)){
