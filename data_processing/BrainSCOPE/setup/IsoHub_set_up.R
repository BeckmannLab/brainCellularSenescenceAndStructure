...
#fix for format
PEC2_sample[which(PEC2_sample$Cohort == "Girgenti-snMultiome"),"Cohort"] = "IsoHuB"
PEC2_mapping[which(PEC2_mapping$Cohort == "Girgenti-snMultiome"),"Cohort"] = "IsoHuB"
...
saveRDS(sces3,"sce_all_IsoHuB.RDS")
