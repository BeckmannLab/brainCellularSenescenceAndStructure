...
# meta_cells = fread("/sc/arion/projects/psychgen/lbp/data/neuroimaging/anina/brainSCOPE/meta/Cell_metadata/Girgenti-multiome_cell_metadata.tsv", data.table = FALSE)
...
saveRDS(sces3,"sce_all_Girgenti-multiome.RDS")
