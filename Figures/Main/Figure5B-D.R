...
myres_final = myres5[,c("feature","assay","spearmans", "ds")]
...
all2_grouped2$new_column = factor(all2_grouped2$new_column, levels = c("livExc", "livMG", "pmExc","pmMG","bsExc", "bsMG"))
...
ggsave("volume_signal_pi1_ggseg.pdf",b, width = 10, height = 10) 
