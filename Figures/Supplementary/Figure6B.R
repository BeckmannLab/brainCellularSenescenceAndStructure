...
all2 = c()
for (i in 1:nrow(var)) {
    file_path = paste0("correct_edger_5andup_", var[i,6], "_", var[i,2], "_fit.RDS")  
...
var = structure(list(V2 = c("1percent", "1percent", "1percent", "1percent", 
...
ggsave("ND_fiveandup_DE_oddsratio_heatmap_sen.pdf", d, width = 10, height = 10)
