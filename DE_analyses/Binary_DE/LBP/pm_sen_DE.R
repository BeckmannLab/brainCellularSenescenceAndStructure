...
#subset to pm cohort
ids <- c("S00021", "S00253", "S00324", "S00556", "S00579", "S00935","S01447", "S01462", "S11088", "S17633", "S17680", "S19335", "T-111", 
"T-164", "T-168", "T-2011", "T-4639.3", "T-4915", "T-5354","T-563")

celltype = c( "Oli", "Int", "Exc","Ast", "MG", "OPC")

##ids
tnbc2 <- subset(lbp, subset = Sample_ID %in% ids)
pm_data =GetAssayData(tnbc2, slot="counts", assay="RNA")
