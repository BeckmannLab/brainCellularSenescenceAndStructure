...
wget https://www.gsea-msigdb.org/gsea/msigdb/human/download_geneset.jsp?geneSetName=REACTOME_SENESCENCE_ASSOCIATED_SECRETORY_PHENOTYPE_SASP&fileType=gmt

kegg = read.delim("reactome_senescence_associated_secretory_phenotye_sasp_msigdb_terms.gmt")
...
final_df_greater_logfcgreater0$enrichment = "SASP"

saveRDS(final_df_greater_logfcgreater0,"sasp_result.RDS")
