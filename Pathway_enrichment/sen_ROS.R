wget https://www.gsea-msigdb.org/gsea/msigdb/human/download_geneset.jsp?geneSetName=HALLMARK_REACTIVE_OXYGEN_SPECIES_PATHWAY&fileType=gmt


kegg = read.delim("ros_msigdb_terms.gmt")
...
V1 = c("1percent","10percent", "5percent", "5percent", "30percent", "30percent")
V2 = c("ast","oli", "exc", "int", "mg", "opc")
...
final_df_greater_logfcgreater0$enrichment = "ROS"
saveRDS(final_df_greater_logfcgreater0, "ros_result.RDS")
