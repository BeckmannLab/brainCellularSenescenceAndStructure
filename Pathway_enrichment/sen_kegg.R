wget wget https://www.gsea-msigdb.org/gsea/msigdb/human/download_geneset.jsp?geneSetName=KEGG_CELL_CYCLE&fileType=gmt


kegg = read.delim("kegg_cell_cycle_msigdb_terms.gmt")
...
final_df_greater_logfcgreater0$enrichment = "cell_cycle"

saveRDS(final_df_greater_logfcgreater0, "cell_cycle_result.RDS")
